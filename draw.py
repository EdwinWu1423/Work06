    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            add_polygon(polygons,points[index][0],points[index][1],points[index][2],
                        ...
                        points[(index+step)%(len(points))][0],points[(index+step)%(len(points))][1],points[(index+step)%(len(points))][2])
            add_polygon(polygons,points[index+1][0],points[index+1][1],points[index+1][2],
                        points[(index+step+1)%(len(points))][0],points[(index+step+1)%(len(points))][1],points[(index+step+1)%(len(points))][2],
                        points[(index+step)%(len(points))][0],points[(index+step)%(len(points))][1],points[(index+step)%(len(points))][2])
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            if (index % step) + 1 == step:
                add_polygon(polygons,points[index][0],points[index][1],points[index][2],
                            points[lat*step][0],points[lat*step][1],points[lat*step][2],
                            points[(index+step)%(len(points))][0],points[(index+step)%(len(points))][1],points[(index+step)%(len(points))][2])
                add_polygon(polygons,points[lat*step][0],points[lat*step][1],points[lat*step][2],
                            points[(lat*step+step)%(len(points))][0],points[(lat*step+step)%(len(points))][1],points[(lat*step+step)%(len(points))][2],
                            points[(index+step)%(len(points))][0],points[(index+step)%(len(points))][1],points[(index+step)%(len(points))][2])
            else:
                add_polygon(polygons,points[index][0],points[index][1],points[index][2],
                            points[(index+1)%(len(points))][0],points[(index+1)%(len(points))][1],points[(index+1)%(len(points))][2],
